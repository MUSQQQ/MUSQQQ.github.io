...
export default class extends AbstractView {
    ...
    async getHtml() {
        ...
        <div class="centerlize">
            <h1 style="font-size: xxx-large;">O nas</h1>
            <p>
            
        
            &emsp; Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas eleifend erat sem, ut ullamcorper neque dictum sed. Suspendisse potenti. Quisque in purus et ligula accumsan molestie nec id sem. Phasellus vitae est ornare, porttitor nisl vitae, laoreet mi. Ut elementum porttitor risus. Nunc accumsan justo et efficitur maximus. Nunc nec urna diam. Duis lacinia fermentum risus, vitae consequat orci lacinia a. </br>  &emsp; Sed consectetur feugiat maximus.
        
        Praesent suscipit, massa nec feugiat finibus, tellus metus congue diam, at porttitor velit metus vitae mauris.
            </p>
          </div>
             <div class="centerlize2">
            <div class="row">
